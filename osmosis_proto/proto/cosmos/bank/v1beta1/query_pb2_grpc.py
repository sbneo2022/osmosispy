...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TotalSupplyWithoutOffset = channel.unary_unary(
                '/cosmos.bank.v1beta1.Query/TotalSupplyWithoutOffset',
                request_serializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryTotalSupplyWithoutOffsetRequest.SerializeToString,
                response_deserializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryTotalSupplyWithoutOffsetResponse.FromString,
                )
        self.SupplyOfWithoutOffset = channel.unary_unary(
                '/cosmos.bank.v1beta1.Query/SupplyOfWithoutOffset',
                request_serializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QuerySupplyOfWithoutOffsetRequest.SerializeToString,
                response_deserializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QuerySupplyOfWithoutOffsetResponse.FromString,
                )
        ...
        self.BaseDenom = channel.unary_unary(
                ...
                request_serializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryBaseDenomRequest.SerializeToString,
                response_deserializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryBaseDenomResponse.FromString,
                )
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TotalSupplyWithoutOffset': grpc.unary_unary_rpc_method_handler(
                    servicer.TotalSupplyWithoutOffset,
                    request_deserializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryTotalSupplyWithoutOffsetRequest.FromString,
                    response_serializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryTotalSupplyWithoutOffsetResponse.SerializeToString,
            ),
            'SupplyOfWithoutOffset': grpc.unary_unary_rpc_method_handler(
                    servicer.SupplyOfWithoutOffset,
                    request_deserializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QuerySupplyOfWithoutOffsetRequest.FromString,
                    response_serializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QuerySupplyOfWithoutOffsetResponse.SerializeToString,
            ),
            ...
            'BaseDenom': grpc.unary_unary_rpc_method_handler(
                    servicer.BaseDenom,
                    request_deserializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryBaseDenomRequest.FromString,
                    response_serializer=cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryBaseDenomResponse.SerializeToString,
            ),
    }
...
class Query(object):
    ...
    @staticmethod
    def TotalSupplyWithoutOffset(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.bank.v1beta1.Query/TotalSupplyWithoutOffset',
            cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryTotalSupplyWithoutOffsetRequest.SerializeToString,
            cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryTotalSupplyWithoutOffsetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def SupplyOfWithoutOffset(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(request, target, '/cosmos.bank.v1beta1.Query/SupplyOfWithoutOffset',
            cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QuerySupplyOfWithoutOffsetRequest.SerializeToString,
            cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QuerySupplyOfWithoutOffsetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BaseDenom(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.bank.v1beta1.Query/BaseDenom',
            cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryBaseDenomRequest.SerializeToString,
            cosmos_dot_bank_dot_v1beta1_dot_query__pb2.QueryBaseDenomResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
