...
from osmosis_proto.proto.perp.v1 import event_pb2 as perp_events
from osmosis_proto.proto.spot.v1 import event_pb2 as spot_events
from osmosis_proto.proto.stablecoin import events_pb2 as stablecoin_events  # noqa
from osmosis_proto.proto.vpool.v1 import event_pb2 as vpool_events


class EventType(Enum):
    """
    The events enum type shows the type of events available to parse from the osmosis websocket object.
    """
